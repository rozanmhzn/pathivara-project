...
const AboutUs = () => {
  return (
    <div className="mb-16">
      <section className="mt-20 ml-20 p-10">
      ...
      <section className="m-20">
        <div className="flex flex-col gap-5 justify-center items-center p-5">
          ...
          <span className="w-11/12 text-lg text-textColor font-medium">
      ...
      <section>
        <div className="ml-20 p-10">
          ...
          <div className="text-xl text-textColor font-medium flex flex-col gap-7 mt-10">
            <span>
